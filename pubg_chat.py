...
def pubg_response(user_input):
    ...
    if message.function_call:
        ...
        if func_name == "search":
            ...
            function_response = { "error": "Unknown function call:" + func_name }
...
# print(pubg_response("how many kills has the player Ots_Numb_ made at PUBG?"))